            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <form role="form" action="{{ route('make-payment') }}" method="post" class="stripe-payment"
                          data-cc-on-file="false" data-stripe-publishable-key="pk_test_51J7ZcUEmlMSPD9MKyAPHeeQV8PiMehTtjXeIZRIM7qtS3oDCSO0tX8j0KaS0MdYA0VSk16Vu3qV6iLI2f9zckzkw00kU02MJG0"
                          id="stripe-payment">
                        @csrf
    ...
    $(function () {
        ...
        $('form.stripe-payment').bind('submit', function (e) {
            ...
            if (!$form.data('cc-on-file')) {
                e.preventDefault();
                Stripe.setPublishableKey('pk_test_51J7ZcUEmlMSPD9MKyAPHeeQV8PiMehTtjXeIZRIM7qtS3oDCSO0tX8j0KaS0MdYA0VSk16Vu3qV6iLI2f9zckzkw00kU02MJG0');
                Stripe.createToken({
                    number: $('.card-num').val(),
                    cvc: $('.card-cvc').val(),
