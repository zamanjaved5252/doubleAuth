...
var Scroller = function ( dt, opts ) {
	...
	this.s = {
		 ...
		 * and when the layout scrolls the viewport in order to stop the cookie set taking too much
		 * CPU!
		 *  @type     int
		 *  @default  0
		 */
...
$.extend( Scroller.prototype, {
	...
	*/
	...
	construct: function ()
	{
		...
		// In iOS we catch the touchstart event in case the layout tries to scroll
	 ...
	 * table that has been drawn so the layout can scroll the whole data set.
	 *
...
Scroller.defaults = {
	 ...
	 * allow the data to look continuous to a layout scrolling through the data). If given as 0
