...
var k=a.s.dtPane.order();var p=b.binsOriginal;var m=b.arrayOriginal;var x=a.dom.collapseButton.hasClass(a.classes.rotated)}void 0===f.searchPanes&&(f.searchPanes={});void 0===f.searchPanes.panes&&(f.searchPanes.panes=[]);for(d=0;d<f.searchPanes.panes.length;d++)f.searchPanes.panes[d].id===a.s.index&&(f.searchPanes.panes.splice(d,1),d--);f.searchPanes.panes.push({arrayFilter:m,bins:p,collapsed:x,id:a.s.index,order:k,searchTerm:g,selected:e})}}));this.s.dtPane.off("layout-select.dtsp");this.s.dtPane.on("layout-select.dtsp",
